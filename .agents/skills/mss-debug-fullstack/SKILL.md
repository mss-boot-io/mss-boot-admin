...
- In a Thin Host, use the installed `mss` v1.3.7 binary.
...
6. For a generated module, compare the source contract with generated output:
   ...
   Remember that the public v1.3.7 profile generates only its documented simple CRUD surface; do not diagnose an unsupported relation, import, workflow, or row-scope request as ordinary generated drift.
