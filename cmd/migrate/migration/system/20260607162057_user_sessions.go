...
func init() {
	...
	migration.Migrate.SetVersion(migration.GetFilename(fileName), _20260607162057UserSessions)
}

func _20260607162057UserSessions(db *gorm.DB, version string) error {
