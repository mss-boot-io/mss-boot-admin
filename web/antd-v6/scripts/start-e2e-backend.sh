...
if content.count('http://localhost:18001') != 1:
    raise SystemExit('expected exactly one localhost frontend origin in the E2E configuration')
...
content = content.replace('http://localhost:18001', f'http://localhost:{web_port}')
