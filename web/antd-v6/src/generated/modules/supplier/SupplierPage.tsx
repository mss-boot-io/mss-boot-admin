    ...
    <PageContainer title={title} content={intl.formatMessage({ id: `${localePrefix}.description` })}>
      ...
      >
        ...
        >
          ...
          >
            <Select options={ creditLevelOptions } />
          </Form.Item>
          <Form.Item
            name="enabled"
