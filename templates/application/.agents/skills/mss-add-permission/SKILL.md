...
description: Add or change coarse backend RBAC, API, menu, or action permissions in a Thin Host v1.3.3 module. Trigger for role access or authorization defects. Row-level ownership and department scope require separate handwritten enforcement.
---

# Add a coarse module permission

The generated v1.3.3 profile projects module permission codes into backend API/RBAC registration and frontend menu/action visibility while `ownership.mode` remains `none`.
