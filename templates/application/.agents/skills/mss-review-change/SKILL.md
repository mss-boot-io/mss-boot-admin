...
5. The v1.3.3 generated profile is limited to `string`/`enum`/`bool`, `ownership: none`, simple CRUD/export, and coarse permissions. Treat generated relation, import, workflow, or row-scope claims as unsupported until separately implemented and tested.
