...
The public site documents the package-first **v1.3.4** Complete Admin
...
- `docs/releases/`: v1.3.4 and a clearly separated read-only archive;
...
The drift check verifies the active v1.3.4 version, package-first commands,
