...
order: 2
description: v1.3.7 候选 Admin 发行架构与 v1.3.5/v1.3.6 永久停止事实
---
...
:::warning
发布策略仍将 **v1.3.2** 定义为当前稳定版本。v1.3.5 与 v1.3.6 已永久停止并保持不可变部分发布；
v1.3.7 已选为 release candidate，但尚未发布。本页只描述源码和候选架构；公共制品对账
前，v1.3.7 不可采用，也不开放安装、创建或升级命令。
:::
