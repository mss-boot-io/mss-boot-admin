---
title: v1.3.3 登录与会话排障
order: 14
nav:
  order: 1
  title: admin
description: 排查 v1.3.3 HttpOnly Cookie 会话、CSRF、刷新、权限和同源代理问题
keywords: [v1.3.3 admin login session cookie csrf troubleshooting]
---
...
提供 v1.3.3 精确版本/提交、页面和 API 路径、状态码、错误 key、发生时间、是否仅影响
