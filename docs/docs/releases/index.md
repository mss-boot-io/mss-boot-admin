...
nav:
  title: 发布
  order: 6
description: v1.3.2 当前稳定、v1.3.5 永久停止与 v1.3.6 未发布候选
---

# 发布

当前稳定版本是 **v1.3.2**。v1.3.5 已永久停止，只保留不可变部分发布记录。v1.3.6 已选
为 release candidate，但尚未发布或完成公共对账。本页不是 v1.3.6 安装、创建或升级入口。
v1.3.6 的页面只描述源码合同与候选预期，当前不可采用。

- [v1.3.6 发布候选说明](/releases/v1-3-6)
- [v1.3.2 当前稳定记录](/releases/archive/v1-3-2)
- [v1.3.5 不可变部分发布记录](/releases/v1-3-5)
- [v1.3.6 候选采用状态](/getting-started)
- [v1.3.6 候选工具状态](/getting-started/tooling)
...
v1.3.6 候选承接，并需要新的 merged-main 资格证据。
