...
title: FAQ
order: 3
description: v1.3.7 未发布候选、v1.3.5/v1.3.6 永久停止与 v1.3.2 稳定边界 FAQ
---
...
为 release candidate，但尚未发布。本页只解释 source-only 与候选合同；公共制品对账前，
v1.3.7 不可采用，也不开放安装、创建或升级命令。
:::

## v1.3.7 现在可以安装或升级吗？

不可以。v1.3.7 只是已选候选，必须先完成唯一非公开 preview、正式组件与 Root 发布、
公共包/镜像/工具对账以及后续 Docs 发布。任何源码构建、本地包或单个候选制品都不能代替
这条证据链。
