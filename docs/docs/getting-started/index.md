...
nav:
  title: 采用状态
  order: 1
description: v1.3.2 当前稳定、v1.3.5/v1.3.6 永久停止与 v1.3.7 未发布候选边界
...
缺失制品；公共 ledger 完成前，v1.3.7 不可采用，也不提供安装、创建、初始化或升级命令。
...
| v1.3.7 协调发行版 | 已选候选、未发布 | 等待同一 merged-main 提交的 preview、正式发布与公共对账 |
